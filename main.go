...
func main() {
	//连接数据库
	dsn := "root:taotaohan0402@tcp(127.0.0.1:3306)/db_word?charset=utf8mb4&parseTime=True&loc=Local"
	...
	rootBackendRouter := rootRouter.Group("/backend")
	// 自定义CORS配置
	//config := cors.Config{
	...
	routers.SetupRouter(rootBackendRouter)
	rootBackendRouter.GET("/", indexHandler)
